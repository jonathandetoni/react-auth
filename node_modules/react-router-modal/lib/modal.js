  ...
  _createClass(Modal, [{
    ...
    value: function componentWillMount() {
      var _props = this.props,
          ...
          outClassName = _props.outClassName,
    ...
    value: function componentWillReceiveProps(next) {
      var className = next.className,
          inClassName = next.inClassName,
          outClassName = next.outClassName,
          backdropClassName = next.backdropClassName,
          backdropInClassName = next.backdropInClassName,
          backdropOutClassName = next.backdropOutClassName,
          outDelay = next.outDelay,
